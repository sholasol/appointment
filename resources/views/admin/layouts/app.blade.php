...
<body class="hold-transition sidebar-mini">
    <div class="wrapper" id="app">
        ...
        <nav class=" main-header navbar navbar-expand navbar-white navbar-light fixed">
            ...
            <ul class="navbar-nav" id="toggleMenuIcon">
                <li class="nav-item">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <router-link to="/admin/create-appointment" active-class="active" class="nav-link">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <router-link to="/admin/create-user" active-class="active" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Create User</p>
                                    </router-link>
                                </li>
